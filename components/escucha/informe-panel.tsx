// Tab Informe: SOLO lectura y generación — el último informe diario, la
// generación on-demand (barrido + síntesis) y el historial. Toda la
// configuración (brief, escenario, conector de Claude, extensión) vive en la
// pestaña Entorno.
